...
<html>
	...
	<body>
			...
			<div class="am-container header">
				...
				<ul class="message-r">
					...
					<div class="topMessage favorite">
						<div class="menu-hd">
							<a href="person/collection.jsp" target="_top"><i class="am-icon-heart am-icon-fw"></i><span>收藏夹</span>
							</a>
						</div>
				</ul>
			</div>
						...
						<div class="wrap-list">
							<div class="m-user">
								...
								<div class="m-userinfo">
									<div class="m-baseinfo">
										<a href="information.html"> <img
												src="images/getAvatar.do.jpg"> </a>
										<em class="s-name">(小叮当)<span class="vip1">
										</em>
								...
								<div class="m-userproperty">
									...
									<p class="m-coupon">
										<a href="coupon.html"> <i><img src="images/coupon.png" />
							...
							<div class="m-order">
								...
								<ul>
									<li>
										<a href="order.html"><i><img src="images/pay.png" />
										</i><span>待付款</span> </a>
									</li>
									<li>
										<a href="order.html"><i><img src="images/send.png" />
										</i><span>待发货<em class="m-num">1</em> </span> </a>
									</li>
									<li>
										<a href="order.html"><i><img src="images/receive.png" />
										</i><span>待收货</span> </a>
									</li>
									<li>
										<a href="order.html"><i><img src="images/comment.png" />
										</i><span>待评价<em class="m-num">3</em> </span> </a>
									</li>
									<li>
										<a href="change.html"><i><img src="images/refund.png" />
										</i><span>退换货</span> </a>
									</li>
								</ul>
							</div>
							...
							<div class="user-patternIcon">
								...
								<ul>
									...
									<a href="home/shopcart.html"><li class="am-u-sm-4">
											<i class="am-icon-shopping-basket am-icon-md"></i>
											<img src="images/iconbig.png" />
											<p>
												购物车
											</p>
										</li> </a>
									<a href="collection.html"><li class="am-u-sm-4">
											<i class="am-icon-heart am-icon-md"></i>
											<img src="images/iconsmall1.png" />
											<p>
												我的收藏
											</p>
										</li> </a>
									<a href="home/home.html"><li class="am-u-sm-4">
											<i class="am-icon-gift am-icon-md"></i>
											<img src="images/iconsmall0.png" />
											<p>
												为你推荐
											</p>
										</li> </a>
									<a href="comment.html"><li class="am-u-sm-4">
											<i class="am-icon-pencil am-icon-md"></i>
											<img src="images/iconsmall3.png" />
											<p>
												好评宝贝
											</p>
										</li> </a>
									<a href="foot.html"><li class="am-u-sm-4">
											<i class="am-icon-clock-o am-icon-md"></i>
											<img src="images/iconsmall2.png" />
											<p>
												我的足迹
											</p>
										</li> </a>
													...
													<div class="J_TipsCon hide">
														...
														<div class="s-tip-content">
															<ul>
																...
																<li class="s-omit">
																	<a data-spm-anchor-id="a1z02.1.1998049142.3"
													...
													<div class="J_TipsCon hide">
														...
														<div class="s-tip-content">
															<ul>
																...
																<li class="s-omit">
																	<a data-spm-anchor-id="a1z02.1.1998049142.7"
																		target="_blank"
		...
		<div class="navCir">
			<li>
				<a href="home/home.html"><i class="am-icon-home "></i>首页</a>
			</li>
			<li>
				<a href="home/sort.html"><i class="am-icon-list"></i>分类</a>
			</li>
			<li>
				<a href="home/shopcart.html"><i class="am-icon-shopping-basket"></i>购物车</a>
			</li>
			<li class="active">
				<a href="index.html"><i class="am-icon-user"></i>我的</a>
			</li>
		</div>
	</body>
