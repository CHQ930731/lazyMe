...
//	public static final String url = "jdbc:mysql://localhost:3306/jiangxi?characterEncoding=gbk";
//	public static final String name = "root";
//	public static final String password = "root";
//	public static final String classname = "com.mysql.jdbc.Driver";
	public static final String url = "jdbc:oracle:thin:@127.0.0.1:1521:ORCL";// 数据库连接，ora
	public static final String name = "scott";
	public static final String password = "chiara";
